...
public class TextureMovieEncoder implements Runnable {
    ...
    private Sprite3d mSpriteLogoRect;
    ...
    private void handleFrameAvailable(float[] transform, long timestampNanos) {
        ...
        setLogoSprite(-350,1080,strDate,Color.YELLOW);
        setLogoSprite( 400,1080,"13.0827,80.2707",Color.WHITE);
    ...
    private void setLogoSprite(int x, int y, String strDate,int color) {


        //Bitmap logoBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.ic_logo_128);
        Bitmap logoBitmap = fromText(strDate, 60,color);
        ...
        float screenAspect = ((float) mInputWindowSurface.getWidth()) / mInputWindowSurface.getHeight();
    ...
    private Bitmap fromText(String text, int textSize, int color) {

        TextPaint paint = new TextPaint();//set pain object
        paint.setTextSize(textSize);//add text to it
        paint.setColor(color);// add color to it
